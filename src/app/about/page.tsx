  ...
  return (
    <div>
      <div className="flex min-h-screen items-center justify-center bg-gray-950 text-white">
        <div className="max-w-4xl rounded-lg bg-indigo-800 p-8 shadow-lg">
          ...
          <p className="mb-8 text-lg text-gray-300">
            ...
            safer, and more accessible. Our platform enables you to swap and
            send money to friends with ease, all while prioritizing security and
            user experience.
          </p>
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-300">
              ...
              providing a secure and user-friendly platform for swapping and
              sending funds globally. We strive to empower individuals to manage
              their finances efficiently and securely.
            </p>
          </div>
          <div className="mb-8">
            <h2 className="mb-3 text-2xl font-semibold">
              Why Choose CryptoScout?
            </h2>
            <ul className="list-inside list-disc text-lg text-gray-300">
              ...
              <li className="mb-2">
                Instant money transfers to friends worldwide
              </li>
              <li className="mb-2">
          ...
          <div>
            ...
            <p className="text-lg text-gray-300">
              Experience the future of financial transactions with CryptoScout.
              Join our community today and discover a simpler, safer, and more
              efficient way to swap and send money to your friends.
            </p>
          </div>
        </div>
      </div>
