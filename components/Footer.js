    ...
    <footer className="px-4 divide-y bg-[#1A1A1A] text-gray-100">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          ...
          >
            <div className="flex items-center justify-center w-12 h−12rounded-fullbg-violet-400 ">
              <Logo />
            </div>
        ...
        <div className=" grid grid-col-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
